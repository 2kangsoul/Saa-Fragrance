// File: src/Features/landingpages/components/ProductCard.tsx
import React from "react";
import type { ProductType } from "../types/productTypes"; // Sesuaikan path ini dengan lokasi file types Anda
...
const ProductCard: React.FC<ProductCardProps> = ({ item, onAddToCart }) => {
  // Fungsi dipindah ke sini karena hanya dipakai oleh kartu ini
  ...
  // Fungsi bintang dipindah ke sini
